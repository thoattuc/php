...
if (isset($_GET['action'])) {
    switch ($_GET['action']) {
        case 'create':
            if (!isset($_POST['username']) || !isset($_POST['password']) || !isset($_POST['email']) || isset($_POST['username']) == '' || isset($_POST['password']) == '' || isset($_POST['email']) == ''){
                ...
                if (count($result) == 0) {
                    ...
                    $sql = "INSERT INTO users (username, password, email, created_at) VALUES ('" . $username . "', '" . $password_crypt . "','" .$email."', '" . $date . "')";
                    pdo_execute($sql);
